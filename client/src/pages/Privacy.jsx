          ...
          <section className='bg-gradient-to-r from-indigo-50 to-violet-50 rounded-xl p-6 border border-indigo-100'>
            ...
            <div className='space-y-2'>
              <div className='flex items-center gap-3'>
                ...
                <a href='mailto:privacy@libraflow.local' className='text-indigo-600 hover:text-indigo-700 font-medium'>
                  privacy@libraflow.local
                </a>
              </div>
              <div className='flex items-center gap-3'>
                <svg className='w-5 h-5 text-indigo-600' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <span className='text-gray-700'>www.libraflow.local</span>
              </div>
            </div>
          </section>
